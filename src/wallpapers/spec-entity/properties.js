...
export const specEntityProperties = [
    ...
    slider('overallmagnitude', 'Overall Magnitude', 0, 20, 9.3, { step: 0.1, fraction: true, precision: 1 }),
    ...
    slider('barwidth', 'Bar Width', 0.05, 1.2, 0.34, { step: 0.01, fraction: true, precision: 2 }),
    slider('bardistance', 'Bar Distance', 0.05, 1.5, 0.45, { step: 0.01, fraction: true, precision: 2 }),
    bool('barsflip', 'Flip Bars', false),
    slider('barslengthchangebysound', 'Bar Length By Sound', 0, 6, 0.4, { step: 0.1, fraction: true, precision: 2 }),
    slider('barslengthinitial', 'Bar Length Initial', 0, 10, 0.1, { step: 0.1, fraction: true, precision: 2 }),

    group('transform', 'Transforms'),
    slider('_2doffsetx', '2D Offset X', -1, 1, 0, { step: 0.01, fraction: true, precision: 2 }),
    slider('_2doffsety', '2D Offset Y', -1, 1, -0.68, { step: 0.01, fraction: true, precision: 2 }),
    slider('_2drotation', '2D Rotation', -180, 180, 0),
    slider('_3drotation', '3D Rotation X', -180, 180, -22),
    slider('_3drotationy', '3D Rotation Y', -89, 89, 18),
    ...
    slider('huechangebysound', 'Hue By Sound', 0, 2, 0.02, { step: 0.01, fraction: true, precision: 2 }),
    slider('hueinitial', 'Hue Initial', -360, 360, 224),
    slider('saturation', 'Saturation', 0, 100, 59),
    slider('lightness', 'Lightness', 0, 100, 33),
    slider('opacitychangebysound', 'Opacity By Sound', 0, 5, 5, { step: 0.01, fraction: true, precision: 2 }),
    slider('opacityinitial', 'Opacity Initial', 0, 1, 0.68, { step: 0.01, fraction: true, precision: 2 }),
    ...
    slider('flowdirection', 'Flow Direction', 0, 360, 321),
    slider('flowvelocity', 'Flow Velocity', 0, 10, 10, { step: 0.1, fraction: true, precision: 2 }),
    slider('flowopacitylimit', 'Flow Opacity Limit', 0, 1, 0.86, { step: 0.01, fraction: true, precision: 2 }),
    ...
    slider('bluepxxshiftfactor', 'Blue Pixel Shift', 0, 3, 2.48, { step: 0.01, fraction: true, precision: 2 }),
    slider('whitepixelsdropspeedfactor', 'White Pixel Drop', 0, 3, 1.3, { step: 0.01, fraction: true, precision: 2 }),

    group('clock', 'Clock'),
    bool('showclock', 'Show Clock', false),
    slider('clocksizea', 'Clock Size A', 0.5, 6, 5.6, { step: 0.1, fraction: true, precision: 1 }),
    slider('clocksizeb', 'Clock Size B', 0.5, 4, 2, { step: 0.1, fraction: true, precision: 1 }),
