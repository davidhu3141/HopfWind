...
export const hopfWindProperties = [
    ...
    slider('magfy', 'Size', 2, 8, 8),
    bool('usefour', 'Use Four Tori', false),
    bool('showonlyhalf', 'Show Not Only Half', false),

    group('rotation', 'Rotation'),
    slider('rot_is', 'Spin Initial Speed', 0, 25, 1, { step: 1, fraction: true, precision: 1 }),
    slider('rot_sg', 'Spin Speed Gain By Loudness', 0, 10, 1, { step: 1, fraction: true, precision: 1 }),
    ...
    slider('opacitydefault', 'Lightness Initial', 0, 1, 0.6, { step: 0.1, fraction: true, precision: 2 }),
    slider('opa_gbs', 'Light Gain By Sound', 0, 5, 1.7, { step: 0.1, fraction: true, precision: 2 }),
    ...
    slider('overallmagnitude', 'Overall Magnitude', 0, 20, 9, { step: 0.1, fraction: true, precision: 1 }),
];
